...
let Area = Base_1 + Base_2
let real_area = Base_1 + Base_2 == base_1_and_2
let total_area = base_1_and_2 / (2 * Height)
game.splash("The area of a trapezoid dimensions:" + Base_1 + "cm by " + Base_2 + "cm divided by " + "2" + "cm multiplied by " + Height + "cm is " + convertToText(total_area) + "cm2")
game.splash("Done")
